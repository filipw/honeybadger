...
{
    /// <summary>
    /// Default GLiNER label -> HoneyBadger entity-type map. The model-side prompt labels mirror the
    /// upstream spaCy NER output names; the values are the entity types HoneyBadger emits.
    /// </summary>
    ...
    /// <summary>
    /// Map of model-side prompt label (lowercase, e.g. <c>person</c>) to the HoneyBadger entity type the
